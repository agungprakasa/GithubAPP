...
import com.example.dicodingsub2.fragment.FollowerFragment
import com.example.dicodingsub2.fragment.FollowingFragment
...
class PagerAdapter(private val mContext: Context, fm: FragmentManager) :
    ...
    override fun getItem(position: Int): Fragment {
        ...
        when (position) {
            ...
            1 -> fragment = FollowingFragment.getInstance(login.toString())
        }
